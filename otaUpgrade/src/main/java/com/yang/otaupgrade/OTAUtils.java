...
import com.yang.otaupgrade.ble.BleCallBack;
import com.yang.otaupgrade.ble.BleScanner;
import com.yang.otaupgrade.ble.OTACallBack;
import com.yang.otaupgrade.ble.OTAUtilsCallBack;
import com.yang.otaupgrade.model.ErrorCode;
import com.yang.otaupgrade.model.FirmWareFile;
import com.yang.otaupgrade.model.OTAType;
import com.yang.otaupgrade.utils.BleUtils;
import com.yang.otaupgrade.utils.HexString;
    ...
    public void updateFirmware(@NonNull String filePath, boolean isQuick, OTAType otaType){
        ...
        if(isConnected){
            ...
            if(BleUtils.checkIsOTA(mBluetoothGatt)){
                ...
                Log.d("TAG", "updateFirmware: "+firmWareFile.getList().size());
...
//                }
    ...
    public void updateFirmware(@NonNull Uri uri, boolean isQuick){
        updateFirmware(uri,isQuick,OTAType.OTA);
    }

    public void updateFirmware(@NonNull Uri uri, boolean isQuick, OTAType otaType){
        this.isQuick = isQuick;
        ...
        if(isConnected){
            ...
            if(BleUtils.checkIsOTA(mBluetoothGatt)){
                ...
                FirmWareFile firmWareFile = new FirmWareFile(mContext.getContentResolver(),uri,isQuick);
                if(firmWareFile.getCode() != 200){
                    callBack.onError(ErrorCode.FILE_ERROR);
                    return;
                }
...
//                }
    ...
    public void updateResource(@NonNull Uri fileUri,boolean isQuick){
        this.isQuick = isQuick;
        ...
        if(isConnected){
            ...
            if(BleUtils.checkIsOTA(mBluetoothGatt)){
                ...
                FirmWareFile firmWareFile = new FirmWareFile(mContext.getContentResolver(),fileUri,isQuick);
                if(firmWareFile.getCode() != 200){
                    callBack.onError(ErrorCode.FILE_ERROR);
                    return;
                }
